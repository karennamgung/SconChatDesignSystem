import {
  ...
  le,
  yv
} from "./chunk-INNBO6N6.js";
import "./chunk-UI5TEFCU.js";
import {
  isVNode,
  watch
} from "./chunk-JUFNBTCT.js";
import {
  require_preview_api
...
var extractArgTypes = (component) => {
  ...
  return ARG_TYPE_SECTIONS.forEach((section) => {
    av(component, section).forEach((extractedProp) => {
      let argType;
...
var extractFromVueDocgenApi = (docgenInfo, section, extractedProp) => {
  ...
  if (section === "props") {
    ...
    if (type = (_c = propInfo.type) == null ? void 0 : _c.name, sbType = extractedProp ? le(extractedProp.docgenInfo) : { name: "other", value: type }, propInfo.type && "elements" in propInfo.type && Array.isArray(propInfo.type.elements) && propInfo.type.elements.length > 0) {
...
var sourceDecorator = (storyFn, ctx) => {
  ...
  return watch(() => ctx.args, () => {
    ...
    channel.emit(yv, { id: ctx.id, args: ctx.args, source: sourceCode, format: "vue" });
...
var shouldSkipSourceCodeGeneration = (context) => {
  ...
  if ((sourceParams == null ? void 0 : sourceParams.type) === Dg.DYNAMIC) return false;
  let isArgsStory = context == null ? void 0 : context.parameters.__isArgsStory;
  return !((context == null ? void 0 : context.viewMode) === "docs") || !isArgsStory || (sourceParams == null ? void 0 : sourceParams.code) || (sourceParams == null ? void 0 : sourceParams.type) === Dg.CODE;
};
...
var generatePropsSourceCode = (args, slotNames, eventNames, ctx) => {
  ...
  Object.entries(args).forEach(([propName, value]) => {
    if (!slotNames.includes(propName) && value != null) switch (typeof value) {
      case "string":
        if (value === "") return;
